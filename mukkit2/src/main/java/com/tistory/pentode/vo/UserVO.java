...
public class UserVO {
	...
	public String toString() {
		return "UserVO [memberid=" + memberid + ", nickname=" + nickname + ", newnickname=" + newnickname
				+ ", password=" + password + ", newpassword=" + newpassword + ", gender=" + gender + ", birthdate="
				+ birthdate + ", joindate=" + joindate + ", memberlv=" + memberlv + ", memberscore=" + memberscore
